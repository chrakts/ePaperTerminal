...
#define SERIAL_0		USARTF0
#define SERIAL_PORT_0	PORTF
#define SERIAL_TE_PIN_0 PIN4_bm
#define SERIAL_RE_PIN_0 PIN5_bm
#define SERIAL_TX_PIN_0 PIN3_bm
#define SERIAL_RX_PIN_0 PIN2_bm
#define T_COMPLETE_INT_0	USARTF0_TXC_vect
#define R_COMPLETE_INT_0	USARTF0_RXC_vect
